      ...
      <div className="container-custom relative">
        <div className="text-center mb-12">
          ...
          <p className="paragraph max-w-2xl mx-auto">
            Our AI analyzes your preferences, dietary needs, and available ingredients to create
            the perfect Algerian meal plan tailored specifically for you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="p-8">
              <h3 className="font-amazigh text-2xl mb-6">Try Our AI Meal Planner</h3>
              <p className="text-gray-600 mb-8">
                Answer a few quick questions about your preferences, and see how our AI creates 
                personalized Algerian meal suggestions for you.
              </p>
              ...
              <div className={styles.questions}>
                ...
                <div className={styles.question}>
                  ...
                  <div className={styles.ingredientIcons}>
                    <div className={`${styles.ingredient} ${styles.active}`}>🌾</div>
          ...
          {/* Dynamic Preview */}
          <div className={`${styles.previewCard} rounded-xl overflow-hidden shadow-lg`}>
            {previewMeal ? (
              <motion.div 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="font-amazigh text-2xl mb-2">Tomorrow's Lunch</h3>
                  <div className="flex items-center mb-4">
                    <span className="text-xl font-bold text-terracotta">{previewMeal.name}</span>
                  ...
                  <div className="mt-4">
                    <h4 className="text-sm font-bold text-gray-500 mb-2">INGREDIENTS YOU ALREADY HAVE:</h4>
              ...
              <div className={styles.emptyPreview}>
                <div className="text-center p-8">
                  ...
                  <h3 className="font-amazigh text-2xl mb-4">Your Perfect Meal</h3>
                  <p className="text-gray-500 mb-6">
                    Take the quick quiz to see your personalized Algerian meal recommendation.
                  </p>
                  <motion.div 
